...
class CJumpBat : public CTrigger
{
	DERIVED_CLASS(CTrigger, CJumpBat)

protected:
	explicit CJumpBat(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CJumpBat(const CJumpBat& rhs);
	virtual ~CJumpBat();

public:
	static CJumpBat* Create(LPDIRECT3DDEVICE9 pGraphicDev, const FSerialize_GameObject& tObjectSerial);
